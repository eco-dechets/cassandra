...
function Materiel({form}: { form: UseFormReturn<any> }) {
    ...
    const alphabeticalList = ({data}: any) => {
        ...
        const filteredData = sortedData.filter((materiel: { category: { name: string }, inventoryNumber: any, serialNumber: string }) =>
                                    ...
                                    render={({field}) => (
                                        <FormItem className={"w-full mb-4"}>
                                            ...
                                            <Select onValueChange={field.onChange}
                                                ...
                                                <SelectContent>
                                                    {alphabeticalList({data: data.filter((m: any) => m.state === "AVAILABLE") ?? []})}
                                                </SelectContent>
                                            </Select>
